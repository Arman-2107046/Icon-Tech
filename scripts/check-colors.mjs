 ...
 *   src/lib/inline-palette.ts  tokens mirrored for Open Graph images (Satori has no CSS vars)
 */
...
const SCAN = ["app", "src"];
const ALLOW = new Set(["app/tokens.css", "app/globals.css", "src/lib/inline-palette.ts"]);
